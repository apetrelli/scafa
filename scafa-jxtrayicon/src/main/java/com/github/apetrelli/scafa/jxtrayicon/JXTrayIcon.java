/*
 * Scafa - Customization of JXTrayIcon
...
package com.github.apetrelli.scafa.jxtrayicon;
...
public class JXTrayIcon extends TrayIcon {
    ...
    private boolean triggeredOnMousePressed = false;
    ...
    public JXTrayIcon(Image image) {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                triggeredOnMousePressed = e.isPopupTrigger() && menu != null;
            }

            public void mouseReleased(MouseEvent e) {
                showJPopupMenu(e);
                triggeredOnMousePressed = false;
            }
        });
    }

    protected void showJPopupMenu(MouseEvent e) {
        if (triggeredOnMousePressed || (e.isPopupTrigger() && menu != null)) {
            showJPopupMenu(e.getX(), e.getY());
        }
    }
